...
<body>
    <div class="logo">
        ...
        @if( $tareasRealizadas->count() + $tareasPendientes->count() + $tareasSinHacer->count() === 0 )
            <p class="mensaje-grande">No tienes tareas para este mes.<br>¡Aprovecha para planear nuevas metas y proyectos!</p>
        @else
